...
| Fixed | 1 picker/station (baseline; GUI can hire more — staffing is a separate experiment), pick-cycle calibration (`WALK_TIME_FIXED=2.9244`, `WALK_TIME_SCALE=0.9872` → TOTAL cycle μ30 s σ10 s, grab folded in, `PICK_GRAB_TIME=0` — user re-spec 2026-07-14), station capacities (`STATIONS`, S5=4 since 2026-07-14), depot 60 s (user-set 2026-07-14, was 45 s), packoff 20 s, spawn cadence (depot fill + 1 cart/5 s), `_PICKER_RNG_SEED` | Everything not under test is frozen |
